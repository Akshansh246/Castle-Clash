class Sprite{
    ...
    updateFrames(){
        ...
        if (this.currentAnimations?.onComplete) {
            if (this.currentFrame === this.frameRate-1 && !this.currentAnimations.isActive) {
                this.currentAnimations.onComplete() 
                this.currentAnimations.isActive = true 
            }
